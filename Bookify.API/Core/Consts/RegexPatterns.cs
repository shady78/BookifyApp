namespace Bookify.API.Core.Consts
{
    public static class RegexPatterns
    {
        ...
        //public const string MobileNumber2 = "^05[0,2,6,9]{1}[0-9]{7}$";  //saudia 
        public const string NationalIDForEgypt = "^[2,3]{1}[0-9]{13}$";
        //public const string NationalIDForSoudia = "^[1]{1}[0-9]{9}$";
    }
}
