namespace Bookify.API.Core.Consts
{
    public static class Errors
    {
        ...
        public const string Dublicated = "Anothor record with the same {0} is already exists!";
        ...
        public const string NotAllowFutureDates = "Date cannot allow in the future!";
        ...
        public const string InvalidMobileNumber = "Inavlid mobile number.";
        public const string InvalidSerialNumber = "Inavlid serial number.";
        public const string NotAvailableRental = "This book/copy not avaliable for rental.";
        public const string InvalidNationalId = "Inavlid National Id.";
